...
class IntelligentRouter:
    ...
    def route(self, query, context=None) -> dict:
        ...
        stopwords = {"what", "is", "my", "for", "to", "in", "with", "the", "a", "an", "of", "it", "on", "at", "by", "that", "this", "from", "you", "me", "i", "we", "us", "they", "them", "our", "your", "day", "days", "please", "can", "could", "should", "would", "how", "why", "where", "when", "who", "which", "are", "do", "does", "did", "have", "has", "had", "will", "shall", "be", "been", "was", "were", "go", "get", "take", "make", "find", "search", "lookup"}
        tokens = set(tok for tok in re.findall(r"[a-z0-9]+", q_lower) if tok not in stopwords)
        if not tokens:
